...
int main()
{
	...
	Shader ourShader("2_lighting/4.2_lighting_maps_emission/lighting_maps_emission.shader");
	#pragma endregion
	...
	Material ourMaterial(
		...
		LoadImageToGPU("../resources/textures/lighting_maps_specular_color.png", GL_RGBA, GL_RGBA, 1),
		LoadImageToGPU("../resources/textures/matrix.jpg", GL_RGB, GL_RGB, 2),
	...
	while (!glfwWindowShouldClose(window))
	{
		...
		for (unsigned int i = 0; i < 10; i++)
		{
			...
			glUniform1i(glGetUniformLocation(ourShader.ID, "material.emission"), 2);
